...
import { useLocation } from 'wouter';
import { useNavigate } from 'react-router-dom';
import { ArrowLeft, Eye, EyeOff, Mail, User, Zap, TrendingUp, BarChart, ArrowRight } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { Input } from '@/components/ui/input';
import { Label } from '@/components/ui/label';
...
const SignUp = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-50 overflow-hidden">
      {/* Animated Background */}
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 left-10 w-32 h-32 bg-gradient-to-r from-blue-500/10 to-purple-500/10 rounded-full floating-element"></div>
        <div className="absolute top-1/2 left-1/3 w-24 h-24 bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-full floating-element" style={{ animationDelay: '-2s' }}></div>
        <div className="absolute bottom-1/4 left-1/4 w-40 h-40 bg-gradient-to-r from-green-500/10 to-blue-500/10 rounded-full floating-element" style={{ animationDelay: '-4s' }}></div>
        <div className="absolute top-1/3 right-1/4 w-28 h-28 bg-gradient-to-r from-pink-500/10 to-red-500/10 rounded-full floating-element" style={{ animationDelay: '-1s' }}></div>
        
        {/* Grid pattern overlay */}
        <div className="absolute inset-0 opacity-[0.02]" style={{ backgroundImage: 'radial-gradient(circle, rgba(30, 41, 59, 0.5) 1px, transparent 1px)', backgroundSize: '50px 50px' }}></div>
      </div>
      ...
      <div className="fixed top-6 right-6 z-50 flex gap-2">
        <Button
          variant="ghost"
          className="glass-light px-4 py-2 rounded-xl text-sm font-medium text-slate-800 hover:scale-105 transition-all duration-300 bg-gradient-to-r from-blue-500/10 to-purple-500/10 shadow-lg"
        >
          Sign Up
        </Button>
        <Button
          variant="ghost"
          onClick={() => navigate('/sign-in')}
          className="glass-light px-4 py-2 rounded-xl text-sm font-medium text-slate-600 hover:scale-105 transition-all duration-300 hover:text-slate-800 shadow-lg"
        >
          Sign In
        </Button>
      </div>
      ...
      <div className="min-h-screen flex page-transition">
        ...
        <div className="hidden lg:block lg:w-[30%] relative animate-slide-in-left">
          <div className="h-full flex flex-col justify-center px-8 xl:px-10">
            ...
            <div className="mb-8">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-10 bg-gradient-to-r from-blue-500 to-purple-600 rounded-xl flex items-center justify-center animate-pulse-glow shadow-lg">
            ...
            {/* Compact Features */}
            <div className="space-y-4 mb-8">
              <div className="card-hover glass-light rounded-xl p-4 shadow-lg">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 icon-gradient-blue rounded-lg flex items-center justify-center flex-shrink-0 shadow-md">
                    <BarChart className="w-4 h-4 text-white" />
                  </div>
                  <div>
                    <h3 className="font-semibold mb-1 text-slate-800">Smart Optimization</h3>
                    <p className="text-slate-600 text-sm">AI-powered campaign optimization</p>
                  </div>
                </div>
              </div>
              ...
              <div className="card-hover glass-light rounded-xl p-4 shadow-lg">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 icon-gradient-purple rounded-lg flex items-center justify-center flex-shrink-0 shadow-md">
                    <Zap className="w-4 h-4 text-white" />
                  </div>
                  <div>
                    <h3 className="font-semibold mb-1 text-slate-800">Creative Generation</h3>
                    <p className="text-slate-600 text-sm">AI-generated ad creatives and copy</p>
                  </div>
                </div>
              </div>
              ...
              <div className="card-hover glass-light rounded-xl p-4 shadow-lg">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 icon-gradient-green rounded-lg flex items-center justify-center flex-shrink-0 shadow-md">
                    <User className="w-4 h-4 text-white" />
                  </div>
                  <div>
                    <h3 className="font-semibold mb-1 text-slate-800">Audience Intelligence</h3>
                    <p className="text-slate-600 text-sm">Precision targeting with AI insights</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex justify-between text-slate-600">
              ...
              <div className="text-center">
                <div className="text-xl font-bold text-slate-800">300%</div>
                <div className="text-xs">ROI Increase</div>
              </div>
            </div>
          </div>
        ...
        <div className="w-full lg:w-[70%] flex items-center justify-center p-6 lg:p-12 animate-slide-in-right">
          <div className="w-full max-w-2xl">
            ...
            <div className="lg:hidden text-center mb-8">
              ...
              <p className="text-slate-600">Join thousands of businesses using AI advertising</p>
            </div>

            {/* Signup Form Container */}
            <Card className="glass-light rounded-3xl border border-slate-200 bg-white/60 shadow-2xl">
              <CardContent className="p-8 lg:p-12">
                {/* Header (Desktop) */}
                <div className="hidden lg:block text-center mb-10">
                  <h2 className="text-4xl text-slate-800 font-bold mb-4">Create Your Account</h2>
                  <p className="text-slate-600 text-xl">Join thousands of businesses using AI advertising</p>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                  <Button
                    type="button"
                    variant="outline"
                    className="social-button w-full flex items-center justify-center gap-3 glass-light py-4 px-6 rounded-2xl text-slate-700 hover:text-black  font-medium bg-white border border-slate-200 hover:bg-blue-50 hover:border-blue-300 transition-colors duration-200 backdrop-blur-md shadow-lg"
                  >
                    <svg className="w-5 h-5" viewBox="0 0 24 24">
                      <path fill="#4285f4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" />
                      <path fill="#34a853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" />
                  ...
                  <Button
                    type="button"
                    variant="outline"
                    className="social-button w-full flex items-center justify-center gap-3 glass-light py-4 px-6 rounded-2xl text-slate-700 font-medium bg-white border border-slate-200 hover:bg-blue-50 hover:border-blue-300  hover:text-black transition-colors duration-200 backdrop-blur-md shadow-lg"
                  >
                    <svg className="w-5 h-5" fill="#1877f2" viewBox="0 0 24 24">
                      <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                    </svg>
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  <div className="space-y-6">
                    <h3 className="text-xl font-semibold flex items-center gap-3 text-slate-800">
                      <div className="w-8 h-8 icon-gradient-blue rounded-lg flex items-center justify-center shadow-md">
                        <User className="w-4 h-4 text-white" />
                      </div>
                      Personal Information
                    </h3>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          value={formData.firstName}
                          onChange={(e) => handleInputChange('firstName', e.target.value)}
                          className="input-focus w-full px-4 py-3 border border-slate-300 rounded-xl bg-white text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-0 transition-all duration-200 shadow-sm hover:border-slate-400"
                          required
                        />
                      </div>
                  ...
                  <div className="space-y-6">
                    <h3 className="text-xl font-semibold flex items-center gap-3 text-slate-800">
                      <div className="w-8 h-8 icon-gradient-purple rounded-lg flex items-center justify-center shadow-md">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        <Input
                          ...
                          value={formData.password}
                          onChange={(e) => handleInputChange('password', e.target.value)}
                          className="input-focus w-full px-4 py-3 pr-12 border border-slate-300 rounded-xl bg-white text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-0 transition-all duration-200 shadow-sm hover:border-slate-400"
                          required
                        />
                        <Button
                          type="button"
                      ...
                      <p className="text-xs text-slate-500">Must be at least 8 characters with mixed case, numbers, and symbols</p>
                    </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      <Checkbox
                        ...
                        checked={formData.agreeToTerms}
                        onCheckedChange={(checked) => handleInputChange('agreeToTerms', checked as boolean)}
                        className="w-5 h-5 mt-0.5 text-blue-600 bg-white border-slate-300 rounded focus:ring-blue-500 focus:ring-2"
                      />
                      <Label htmlFor="agreeToTerms" className="text-sm text-slate-600 leading-relaxed cursor-pointer">
                        I agree to the <Button variant="link" className="p-0 h-auto text-blue-600 hover:text-blue-700 font-medium">Terms of Service</Button> and <Button variant="link" className="p-0 h-auto text-blue-600 hover:text-blue-700 font-medium">Privacy Policy</Button>
                      </Label>
                    </div>
                    <div className="flex items-start gap-3">
                      <Checkbox
                        ...
                        className="w-5 h-5 mt-0.5 text-blue-600 bg-white border-slate-300 rounded focus:ring-blue-500 focus:ring-2"
                      />
                      <Label htmlFor="marketingEmails" className="text-sm text-slate-600 leading-relaxed cursor-pointer">
                        Send me marketing emails about product updates and special offers
                      </Label>
                    </div>
                  </div>
                  ...
                  <Button
                    type="submit"
                    className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold py-4 px-6 rounded-xl hover:from-blue-700 hover:to-purple-700 focus:outline-none focus:ring-4 focus:ring-blue-300 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed"
                    disabled={!isFormValid() || isLoading}
                  >
                    {isLoading ? (
