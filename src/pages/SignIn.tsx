...
import FacebookLoginButton from '@/components/FacebookSignIn';
...
const SignIn = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-slate-50 to-white overflow-hidden text-slate-800">
      {/* Animated Background */}
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 left-10 w-32 h-32 bg-gradient-to-r from-blue-100/60 to-purple-100/60 rounded-full floating-element"></div>
        <div className="absolute top-1/2 left-1/3 w-24 h-24 bg-gradient-to-r from-purple-100/60 to-pink-100/60 rounded-full floating-element" style={{ animationDelay: '-2s' }}></div>
        <div className="absolute bottom-1/4 left-1/4 w-40 h-40 bg-gradient-to-r from-emerald-100/60 to-blue-100/60 rounded-full floating-element" style={{ animationDelay: '-4s' }}></div>
        <div className="absolute top-1/3 right-1/4 w-28 h-28 bg-gradient-to-r from-pink-100/60 to-red-100/60 rounded-full floating-element" style={{ animationDelay: '-1s' }}></div>
        
        {/* Grid pattern overlay */}
        <div className="absolute inset-0 opacity-5" style={{ backgroundImage: 'radial-gradient(circle, rgba(30, 41, 59, 0.1) 1px, transparent 1px)', backgroundSize: '50px 50px' }}></div>
      </div>
      ...
      <Button
            ...
            size="sm"
            onClick={() => navigate('/')}
            className="bg-btn-gradient px-4 py-2 text-slate-700 font-medium rounded-xl border border-slate-300 hover:border-slate-400"
          >
            <ChevronLeft className="w-4 h-4" />
            <span>Back</span>
          </Button>
      ...
      <div className="fixed top-6 right-6 z-50 flex gap-2">
        ...
        <Button
          variant="ghost"
          onClick={() => navigate('/signup')}
          className="glass-light px-4 py-2 rounded-xl text-sm font-medium text-slate-700 hover:scale-105 transition-all duration-300 border border-slate-200"
        >
          Sign Up
        </Button>
        <Button
          variant="ghost"
          className="glass-light px-4 py-2 rounded-xl text-sm font-medium text-white hover:scale-105 transition-all duration-300 bg-gradient-to-r from-blue-500 to-purple-500"
        >
          Sign In
        </Button>
      </div>
      ...
      <div className="min-h-screen flex page-transition">
        ...
        <div className="hidden lg:block lg:w-[30%] relative animate-slide-in-left">
          <div className="h-full flex flex-col justify-center px-8 xl:px-10">
            ...
            {/* Benefits Cards */}
            <div className="space-y-4 mb-8">
              <div className="card-hover glass-light rounded-xl p-4 shadow-sm">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 icon-gradient-blue rounded-lg flex items-center justify-center flex-shrink-0">
                    <Shield className="text-white w-4 h-4" />
                  </div>
                  <div>
                    <h4 className="font-semibold text-sm text-slate-800">Secure Access</h4>
              ...
              <div className="card-hover glass-light rounded-xl p-4 shadow-sm">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-sm text-slate-800">Quick Setup</h4>
                    <p className="text-xs text-slate-500">Get back to creating ads</p>
                  </div>
                </div>
              </div>
              ...
              <div className="card-hover glass-light rounded-xl p-4 shadow-sm">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-sm text-slate-800">Performance Tracking</h4>
            ...
            <div className="flex justify-between text-slate-500">
              ...
              <div className="text-center">
                <div className="text-xl font-bold text-slate-800">5min</div>
                <div className="text-xs">Setup Time</div>
              </div>
            </div>
          </div>
        ...
        <div className="w-full lg:w-[70%] flex items-center justify-center p-6 lg:p-12 animate-slide-in-right">
          <div className="w-full max-w-2xl">
            ...
            <div className="lg:hidden text-center mb-8">
              ...
              <p className="text-slate-600">Continue your AI advertising journey</p>
            </div>

            {/* Sign In Form Container */}
            <Card className="glass-light rounded-3xl shadow-2xl bg-white/80 border border-slate-200">
              <CardContent className="p-8 lg:p-12">
                <div className="text-center mb-8">
                  <h3 className="text-3xl lg:text-4xl font-bold mb-2 text-slate-800">Welcome Back</h3>
                  <p className="text-slate-600 text-lg lg:text-xl">Access your <span className="gradient-text">TEadifyz.AI</span> account</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        value={formData.email}
                        onChange={(e) => handleInputChange('email', e.target.value)}
                        className="glass-input w-full bg-slate-50/50 text-slate-800 pl-12 pr-4 py-4 rounded-2xl placeholder:text-slate-400 border border-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-500/20"
                        required
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <Input
                        ...
                        value={formData.password}
                        onChange={(e) => handleInputChange('password', e.target.value)}
                        className="glass-input w-full bg-slate-50/50 text-slate-800 pl-4 pr-12 py-4 rounded-2xl placeholder:text-slate-400 border border-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-500/20"
                        required
                      />
                      <Button
                        type="button"
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Button variant="link" className="p-0 h-auto text-sm text-blue-600 hover:text-blue-500 font-medium transition-modern"
                    onClick={() => navigate('/forgot-password')}
                    >
                      Forgot password?
                    </Button>
                ...
                <div className="mt-8 text-center">
                  <p className="text-slate-600">
                    ...
                    <Button 
                      variant="link" 
                      className="p-0 h-auto text-sm text-blue-600 hover:text-blue-500 font-semibold ml-1 transition-modern" 
                      onClick={() => navigate('/signup')}
                    >
                      Sign Up
                    </Button>
