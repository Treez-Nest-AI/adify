...
//   const isAnglesDataValid = (anglesData) => {
...
//         'https://tedifyz.app.n8n.cloud/webhook/d664dc96-6d9d-419b-aee8-c1cf23dd8fb2/nest-ai/projectangles',
//         requestBody,
//         {
//           headers: {
...
//         const responseContent = response.data[0]?.message?.content;

//         if (responseContent && responseContent.angles) {
//           // The API returns data in 'angles' array
//           const angles = responseContent.angles;
...
//           console.log('Successfully set and stored marketing angles:', angles);
//         } else {
//           console.error('Response structure:', responseContent);
//           throw new Error('Invalid response format from marketing angles API - angles array not found');
//         }
//       } else {
//         console.error('Empty or invalid response:', response.data);
//         throw new Error('No marketing angles data received from API');
//       }
//     } catch (error: any) {
...
//   // const handleCreateCampaign = () => {
//   //   // Instead of navigating immediately, open the modal
...
//   //     description: "You are now connected to Meta!",
//   //   });
...
//     };
//     return colors[trigger.toLowerCase()] || 'bg-gradient-to-r from-gray-100 to-slate-100 text-gray-700 border-gray-200';
//   };
...
//               onSkip={() => setIsMetaModalOpen(false)}
//             /> */}
//           </div>
//         </div>
//       </div>
...
const parseMarketingAnglesResponse = (responseData: any): MarketingAngle[] => {
  ...
  const generateMarketingAngles = async (storedData: any) => {
    try {
      ...
      const response = await axios.post(
        'https://base234.app.n8n.cloud/webhook/d664dc96-6d9d-419b-aee8-c1cf23dd8fb2/nest-ai/projectangles',
